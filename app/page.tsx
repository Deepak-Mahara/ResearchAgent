...
export default function ResearchDashboard() {
  ...
  const handleStartResearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Update LLM Specialist Reasoning Nodes
      setCurrentStage("llm_analysis");
      await new Promise((res) => setTimeout(res, 800));
      
      // Update Portfolio Judge Synthesis Node
      setCurrentStage("final_decision");
      await new Promise((res) => setTimeout(res, 600));
      
      // Map the live report generated by Gemini 1.5 Pro directly to the UI panel
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-12">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* Visual Institutional Report Output */}
          {report && (
